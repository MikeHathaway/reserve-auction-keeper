...
import { FlashArbExecutorV3V2 } from "../contracts/FlashArbExecutorV3V2.sol";
...
contract DeployFlashArbExecutorV3V2Script {
    Vm internal constant vm =
        Vm(address(uint160(uint256(keccak256("hevm cheat code")))));

    event FlashArbExecutorV3V2Deployed(
    ...
    function run() external returns (FlashArbExecutorV3V2 executor) {
        ...
        emit FlashArbExecutorV3V2Deployed(
            address(executor),
            ajnaToken,
            swapRouter,
            uniswapV3Factory,
